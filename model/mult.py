...
class MULT(nn.Module):
    def __init__(self, audio_dim, text_dim, video_dim, output_dim1, output_dim2,
                  output_dim3, attn_mask, layers, dropout, num_heads, hidden_dim, conv1d_kernel_size, grad_clip):
        ...
        self.fc_out_3 = nn.Linear(output_dim, output_dim3)
    ...
    def forward(self, batch): # audio_feat, text_feat, visual_feat ):# batch
        '''
