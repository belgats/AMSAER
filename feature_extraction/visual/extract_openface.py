...
def extract(input_dir, process_type, save_dir, face_dir, hog_dir, pose_dir):
    ...
    for i, vid in enumerate(vids, 1):
        ...
        if process_type == 'faceDir':
            ...
            exe_path = os.path.join("/home/slasher/MER2023-Baseline/tools/openface/build/", 'bin/FeatureExtraction') #config.PATH_TO_OPENFACE_Win
            commond = '/home/slasher/MER2023-Baseline/tools/openface/build/bin/FeatureExtraction -verbose -f \"%s\" -out_dir \"%s\"' % ( input_root, save_root)
            print("commond")
            os.system(commond)
...
if __name__ == '__main__':
    ...
    input_dir = "/home/slasher/MER2023-Baseline/dataset-process/video/" #config.PATH_FROM_RAW_FACE[dataset]

    # out: feature csv dir   config.PATH_TO_FEATURES_Win[dataset] 
    save_dir = os.path.join("/home/slasher/MER2023-Baseline/dataset-process/features/", 'openface_all')
    hog_dir  = os.path.join("/home/slasher/MER2023-Baseline/dataset-process/features/", 'openface_hog')
    pose_dir = os.path.join("/home/slasher/MER2023-Baseline/dataset-process/features/", 'openface_pose')
    face_dir = os.path.join("/home/slasher/MER2023-Baseline/dataset-process/features/", 'openface_face')
    ...
    #os.system('/home/slasher/MER2023-Baseline/tools/openface/build/bin/FeatureExtraction -verbose -f "../../tools/openface/samples/default.wmv" ')
    print(f'==> Finish')