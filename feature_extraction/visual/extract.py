...
##################### Pretrained models #####################
CLIP_VIT_BASE = 'clip'  # https://huggingface.co/openai/clip-vit-base-patch32
...
if __name__ == '__main__':
    ...
    face_dir = '/home/slasher/MER2023-Baseline/dataset-process/features/openface_face/'

    # gain save_dir
    save_dir = os.path.join('/home/slasher/MER2023-Baseline/dataset-process/features/', f'{model_name}-{params.feature_level[:3]}')
    ...
    if params.model_name in [CLIP_VIT_BASE, CLIP_VIT_LARGE, DATA2VEC_VISUAL, VIDEOMAE_BASE, VIDEOMAE_LARGE]: # from huggingface
        model_dir = os.path.join('/home/slasher/MER2023-Baseline/tools/', f'transformers/{params.model_name}')
