...
if __name__ == '__main__':
    ...
    save_dir = os.path.join('/home/slasher/MER2023-Baseline/dataset-process/features/', f'manet_{params.feature_level[:3]}')
    if not os.path.exists(save_dir): os.makedirs(save_dir)

    # load model
    model = manet(num_classes=7).cuda()
    checkpoint_file = os.path.join('/home/slasher/MER2023-Baseline/tools', 'manet/[02-08]-[21-19]-model_best-acc88.33.pth')
