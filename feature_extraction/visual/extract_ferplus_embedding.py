...
if __name__ == "__main__":
    ...
    face_dir = '/home/slasher/MER2023-Baseline/dataset-process/features/openface_face/' #config.PATH_TO_RAW_FACE[params.dataset]
    save_name = f"{params.model_name.split('_')[0]}face_{params.feature_level[:3]}"
    save_dir = os.path.join('/home/slasher/MER2023-Baseline/dataset-process/features/', save_name) # config.PATH_TO_FEATURES[params.dataset]
    if not os.path.exists(save_dir): os.makedirs(save_dir)

    # load pre-trained model
    pretrained_dir =  '/home/slasher/MER2023-Baseline/tools/ferplus' #os.path.join(config.PATH_TO_PRETRAINED_MODELS, 'ferplus') # directory of pre-trained models
