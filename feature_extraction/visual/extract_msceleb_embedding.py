...
if __name__ == '__main__':
    ...
    save_dir = os.path.join('/home/slasher/MER2023-Baseline/dataset-process/features/', f'msceleb_{params.feature_level[:3]}')
    if not os.path.exists(save_dir): os.makedirs(save_dir)

    # load model
    checkpoint_file = os.path.join('/home/slasher/MER2023-Baseline/tools/', 'msceleb/resnet18_msceleb.pth')
