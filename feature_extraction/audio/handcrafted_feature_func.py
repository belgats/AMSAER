...
class OPENSMILE(object):
    def __init__(self, path):
        ...
        else: # linux /home/slasher/opensmile/build/progsrc/smilextract/
            self.OPENSMILE_EXE = os.path.join(self.path, r'build/progsrc/smilextract/SMILExtract')

        # eGeMAPS
        self.eGeMAPS_CFG_FILE = os.path.join(self.path, r'config/egemaps/v01a/eGeMAPSv01a.conf')
        # IS09
        self.IS09_Emo_CFG_FILE = os.path.join(self.path, r'config/is09-13/IS09_emotion.conf')
        # IS10
        self.IS10_Emo_CFG_FILE = os.path.join(self.path, r'config/is09-13/IS10_paraling.conf')
        # IS13
        self.IS13_ComParE_CFG_FILE = os.path.join(self.path, r'config/is09-13/IS13_ComParE.conf')
