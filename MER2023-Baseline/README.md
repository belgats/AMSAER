...
python main-baseline.py normalize_dataset_format_label --data_root='./dataset-release' --save_root='./dataset-process'
...
## multimodal
python -u main-release.py --dataset='MER2023' --model_type='attention' --test_sets='train' --audio_feature='eGeMAPS_UTT' --text_feature='MARBERTv2-4-UTT' --video_feature='resnet50face_UTT' --lr=1e-3 --gpu=0
```
